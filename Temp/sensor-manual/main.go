...
var (
	...
	minhaEmpresa string
	ipDoNo       string // Variável que guarda o IP do Nó alvo
)
...
func enviarParaCometBFT(pacote PacoteBase) {
	...
	// Agora a URL usa o IP dinâmico digitado pelo usuário
...
func menu() {
	...
	// Solicita o IP do nó do laboratório
	fmt.Print("Digite o IP do Nó da Blockchain (ex: 172.16.201.2:26657): ")
	ipInput, _ := reader.ReadString('\n')
	ipDoNo = strings.TrimSpace(ipInput)
